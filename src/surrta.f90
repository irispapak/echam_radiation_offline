...
CONTAINS
  ...
  SUBROUTINE read_rrta1
    ...
    READ(11,'(//)')
    READ(11,readform) absa(:,:)
!    CALL p_bcast(absa, p_io)
    READ(11,readform) absb(:,:)
!    CALL p_bcast(absb, p_io)
    READ(11,readform) fracrefa(:)
!    CALL p_bcast(fracrefa, p_io)
    READ(11,readform) fracrefb(:)
!    CALL p_bcast(fracrefb, p_io)
    READ(11,readform) forref(:)
!    CALL p_bcast(forref, p_io)
    READ(11,readform) selfref(:,:)
...
!    CALL p_bcast(forref, p_io)
    READ(11,readform) selfref(:,:)
!    CALL p_bcast(selfref, p_io)
    READ(11,readform) absn2oa(:)
!    CALL p_bcast(absn2oa, p_io)
    READ(11,readform) absn2ob(:)
!    CALL p_bcast(absn2ob, p_io)
    READ(11,readform) etaref(:)
!    CALL p_bcast(etaref, p_io)
    READ(11,readform) h2oref(:)
!    CALL p_bcast(h2oref, p_io)
    READ(11,readform) n2oref(:)
!    CALL p_bcast(n2oref, p_io)
    READ(11,readform) co2ref(:)
!    CALL p_bcast(co2ref, p_io)
    READ(11,readform) strrat
...
!    CALL p_bcast(fracrefb, p_io)
    READ(11,readform) selfref(:,:)
!    CALL p_bcast(selfref, p_io)
    READ(11,readform) strrat1
!    CALL p_bcast(strrat1, p_io)
    READ(11,readform) strrat2
...
!CDIR DU_UPDATE(FRACREFB)
  ...
  SUBROUTINE read_rrta6
    ...
    READ(11,readform) absa(:,:)
!    CALL p_bcast(absa, p_io)
    READ(11,readform) absco2(:)
!    CALL p_bcast(absco2, p_io)
    READ(11,readform) cfc11adj(:)
!    CALL p_bcast(cfc11adj, p_io)
    READ(11,readform) cfc12(:)
...
!    CALL p_bcast(fracrefb, p_io)
    READ(11,readform) selfref(:,:)
!    CALL p_bcast(selfref, p_io)
    READ(11,readform) absco2a(:)
!    CALL p_bcast(absco2a, p_io)
    READ(11,readform) absco2b(:)
...
!    CALL p_bcast(absn2ob, p_io)
    READ(11,readform) cfc12(:)
!    CALL p_bcast(cfc12, p_io)
    READ(11,readform) cfc22adj(:)
!    CALL p_bcast(cfc22adj, p_io)
    READ(11,readform) h2oref(:)
!    CALL p_bcast(h2oref, p_io)
    READ(11,readform) n2oref(:)
!    CALL p_bcast(n2oref, p_io)
    READ(11,readform) o3ref(:)
...
!    CALL p_bcast(fracrefb, p_io)
    READ(11,readform) selfref(:,:)
!    CALL p_bcast(selfref, p_io)
    READ(11,readform) absn2o(:)
!    CALL p_bcast(absn2o, p_io)
    READ(11,readform) ch4ref(:)
