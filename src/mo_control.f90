...
!LT 
  INTEGER :: nn = 63             !   max meridional wave number for m=0.
...
!LT
  INTEGER :: nlev = 47      !   number of vertical levels.
  ...
  INTEGER :: nvclev = 48    !   number of levels with vertical coefficients.
  ...
  LOGICAL :: lhd_highres = .FALSE. ! .true. for high resolution (0.5 deg) HD output
  ...
  LOGICAL :: ldebughd          = .FALSE. ! to debug hd model
